                 ...
                 ?> 
					...
					<tbody>
						...
						<tr class="odd gradeX">
							...
							<td><a href="customer.php?id=<?php echo $result['customer_id'] ?>">Xem khách hàng</a></td>

							<td>
								<?php if($result['status']==0){?>
								<a href="?shiftid=<?php echo $result['id']; ?>
                                &qty=<?php echo $result['quantity']; ?>
                                &proid=<?php echo $result['productId']; ?>
                                &price=<?php echo $result['price']; ?>
                                &time=<?php echo $result['date_order']; ?>
                                &cusid=<?php echo $result['customer_id']; ?>"
                                >Đang chờ xử lý</a>
								<?php 
								}elseif($result['status']==1) {

								 ?>
								<a href="?confirmid=<?php echo $result['id'] ?>&price=<?php echo $result['price']; ?>&time=<?php echo $result['date_order'] ?>">Gửi hàng</a>
								 <?php 
